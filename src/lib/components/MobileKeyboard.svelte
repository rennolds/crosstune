...
<div class="virtual-keyboard md:hidden fixed bottom-0 left-0 right-0 bg-gray-100 shadow-lg pb-2 dark:text-black">
  ...
  <div class="px-1 pb-2 space-y-2"> <!-- Reduced horizontal padding, increased vertical gap -->
    ...
    <div class="flex gap-1">
      {#each (showSymbols ? symbolRow1 : letterRow1) as key}
        <button
          class="flex-1 h-12 bg-white rounded shadow text-base font-semibold flex items-center justify-center hover:bg-gray-200 active:bg-gray-300"
    ...
    <div class="flex gap-1">
      ...
      <button
        class="w-12 h-12 bg-white rounded shadow text-xs font-semibold flex items-center justify-center hover:bg-gray-200 active:bg-gray-300"
