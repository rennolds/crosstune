  ...
  {#if isOpen}
    ...
    >
      <div class="p-5 flex flex-col h-full relative">
        <div class="menu-close absolute top-10 right-4 cursor-pointer" on:click={handleClose}>
        ...
        <div class="menu-content mt-10">
          <div class="menu-navigation">
            <div class="menu-item cursor-pointer text-black dark:text-white text-lg py-1 hover:text-gray-400" on:click={navigateToHome}>Home</div>
            <div class="menu-item cursor-pointer text-black dark:text-white text-lg py-1 hover:text-gray-400" on:click={navigateToArchives}>Archives</div>
            <div class="menu-item cursor-pointer text-black dark:text-white text-lg py-1 hover:text-gray-400" on:click={handleFollowUs}>Follow Us</div>
            <div class="menu-item cursor-pointer text-black dark:text-white text-lg py-1 hover:text-gray-400" on:click={handlePrivacy}>Privacy</div>
          </div>
          <div class="menu-section mt-8">
            <h3 class="text-black dark:text-white text-xl font-bold mb-4">Our Games</h3>
            ...
            <div class="game-card mb-4 ml-2 cursor-pointer hover:scale-105 transition-transform" on:click={handleSpotle}>
              ...
              <div class="game-title text-black dark:text-white text-base font-semibold mt-2">Spotle: Guess the Artist</div>
            </div>
            ...
            <div class="game-card mb-4 ml-2 cursor-pointer hover:scale-105 transition-transform" on:click={handleHarmonies}>
              ...
              <div class="game-title text-black dark:text-white text-base font-semibold mt-2">Harmonies: Music Connections</div>
            </div>
          </div>
        </div>
        
        <div class="menu-footer mt-auto pt-6 pb-5">
          <div class="footer-text text-black dark:text-white text-sm">made by flatwhite studios</div>
