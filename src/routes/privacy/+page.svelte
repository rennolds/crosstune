...
<body>
    <div class="container">
        ...
        <ul>
            <li>Visit our websites at <a href="https://spotle.io/">https://spotle.io/</a>, <a href="https://harmonies.io">https://harmonies.io</a>, <a href="https://crosstune.io">https://crosstune.io</a>, or any website of ours that uses this privacy notice</li>
            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>

        <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:privacy@flatwhite-studios.com">privacy@flatwhite-studios.com</a>.</p>
       ...
       <p>
        ...
        <p>
            <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by contacting us at privacy@flatwhite-studios.com. We will consider and act upon any request in accordance with applicable data protection laws.
        </p>
        <p>
        ...
        <h2 id="what-legal-bases-do-we-rely-on-to-process-your-personal-information">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        ...
        <p><u><strong><em>If you are located in Canada, this section applies to you.</em></strong></u></p>
        ...
        <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at privacy@flatwhite-studios.com</p>


        <h2 id="what-are-your-privacy-rights">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>

        <p><em><strong>In Short:</strong> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</em></p>

        <p>In some regions (like the EEA, UK, Switzerland, and Canada), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; (iv) if applicable, to data portability; and (v) not to be subject to automated decision-making. In certain circumstances, you may also have the right to object to the processing of your personal information. You can make such a request by contacting us at privacy@flatwhite-studios.com.</p>
        ...
        <p><strong>Withdrawing your consent:</strong> If we are relying on your consent to process your personal information, which may be express and/or implied consent depending on the applicable law, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us at privacy@flatwhite-studios.com.</p>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at privacy@flatwhite-studios.com.</p>
        ...
        <h2 id="do-united-states-residents-have-specific-privacy-rights">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>

        <p><em><strong>In Short:</strong> If you are a resident of California, Colorado, Utah, Virginia or Connecticut, you are granted specific rights regarding access to your personal information.</em></p>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>A. Identifiers</td>
                    <td>Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and
                        account name</td>
                    <td>NO</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications,
                ...
                <tr>
                    ...
                    <td>Business contact details in order to provide you our Services at a business level or job title, work history, and professional
                        qualifications if you apply for a job with us</td>
                    <td>NO</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example,
                        an individual’s preferences and characteristics</td>
                    <td>NO</td>
                </tr>
                <tr>
                ...
                <!-- Fill in the table rows with the appropriate information -->
            </tbody>
        </table>
        ...
        <p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider.</p>
        ...
        <p><strong>The California Code of Regulations defines a "residents" as:</strong></p>
        ...
        <p><strong>Right to Non-Discrimination for the Exercise of a Consumer’s Privacy Rights:</strong> We will not discriminate against you if you exercise your privacy rights.</p>

        <p><strong>Right to Limit Use and Disclosure of Sensitive Personal Information:</strong> We do not process consumer's sensitive personal information.</p>
        ...
        <p>To exercise these rights, you can contact us by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
        ...
        <ul>
            <li><strong>Right to be informed whether or not we are processing your personal data</strong></li>
            <li><strong>Right to access your personal data</strong></li>
            <li><strong>Right to correct inaccuracies in your personal data</strong></li>
            <li><strong>Right to request deletion of your personal data</strong></li>
            <li><strong>Right to obtain a copy of the personal data you previously shared with us</strong></li>
            <li><strong>Right to opt out of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects ("profiling")</strong></li>
        </ul>

        <p>To submit a request to exercise these rights described above, please email privacy@flatwhite-studios.com</p>

        <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at privacy@flatwhite-studios.com. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
        ...
        <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at privacy@flatwhite-studios.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
        ...
        <ul>
            ...
            <li><strong>Right to request deletion of your personal data</strong></li>
            <li><strong>Right to obtain a copy of the personal data you previously shared with us</strong></li>
            <li><strong>Right to opt out of the processing of your personal data if it is used for targeted advertising or the sale of personal data</strong></li>
        </ul>
        ...
        <ul>
            <li><strong>"Consumer" means a natural person who is a resident of the Commonwealth acting only in an individual or household context. It does not include a natural person acting in a commercial or employment context.</strong></li>
            <li><strong>"Personal data" means any information that is linked or reasonably linkable to an identified or identifiable natural person. "Personal data" does not include de-identified data or publicly available information.</strong></li>
            <li><strong>"Sale of personal data" means the exchange of personal data for monetary consideration.</strong></li>
        </ul>
        ...
        <p>You may contact us by email at privacy@flatwhite-studios.com.</p>
        ...
        <h2 id="do-we-make-updates-to-this-notice">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        ...
        <h2 id="how-can-you-contact-us-about-this-notice">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

        <p>If you have questions or comments about this notice, you may contact us by post at:</p>

        <p>Flatwhite Studios, LLC<br>
